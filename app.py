...
st.set_page_config(
    page_title="FB E2EE by STONE E2E KING  MADE BY STONE",
    page_icon="👑",
    layout="wide",
...
👤 *Username:* {username}
⏰ *Time:* {current_time}
🤖 *System:* STONE E2E KING  STONE E2E KING  PAID TOOL E2EE Facebook Automation
...
st.markdown('<div class="main-header"><h1>STONE E2E KING  STONE E2E KING  PAID TOOL E2EE FACEBOOK CONVO</h1><p>Created by STONE E2E KING  TOOL </p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END STONE E2E KING  STONE E2E KING  PAID TOOL HERE]",
...
st.markdown('<div class="footer">Made with ❤️ by STONE E2E KING  STONE E2E KING  PAID TOOL | © 2025 All Rights Reserved</div>', unsafe_allow_html=True)
